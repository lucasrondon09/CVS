...
if($rowsQuery > 0){
	...
	$capa	 	= $res['capa'];
	$dir		= "../images/galeria/".$titulo."/".$capa;
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Editar</div>
            <div class="card-body">
              <form action="galeria_editar_action.php" method="post" enctype="multipart/form-data">
				  <div class="row">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="<?php echo $resImagem[8][1]?>" name="descricao" value="<?php echo $descricao?>">
				  </div>
