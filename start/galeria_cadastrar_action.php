...
$dir = mkdir("../images/galeria/".$titulo) or die("<div class='alert alert-danger' role='alert'><b>Não foi possível criar uma pasta com o título informado, verifique!</b>");

	

// Nome da imagem
$nome_final_img = '../images/galeria/'.$titulo.'/'.$arquivoName;
