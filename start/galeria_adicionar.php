        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
				...
				<div class="row">
				<?php
				$dir= '../images/galeria/'.$titulo.'/';
				$queryItens = "select * from galeria_itens where galeriaid =".$idgaleria." and st > 0 order by idgaleria_itens desc";
				...
				if($rowsQueryItens > 0){
					...
					<div class="thumbnail">
					  ...
					  <div class="caption">
						<h6>'.$titulo_itens.'</h6>
						<p>
						<a href="galeria_itens_excluir.php?idItem='.$idgaleria_itens.'" class="btn btn-danger btn-block" role="button">Excluir</a> 
						</p>
					  </div>
					</div>
				  </div>
